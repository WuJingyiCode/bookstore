...
<form action="<c:url value='/AdminBookServlet?method=addBook'/>" method="post"<%-- enctype="multipart/form-data"--%>>
	图书名称：<input style="width: 150px; height: 20px;" type="text" name="bname"/><br/>
	图书图片：<input style="width: 223px; height: 20px;" type="text" name="image"/><br/>
